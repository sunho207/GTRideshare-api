...
var error = function(header, message) {
    winston.log('error', header + " : " + message);
}

/*
* Logs a warning
* param: header (string) - log header e.g. 'Warn Timestamp: 1519211809934'
* param: message (string) - log message
*/
var warn = function(header, message) {
    winston.log('warn', header + " : " + message);
}

/*
* Logs information
* param: header (string) - log header e.g. 'Info Timestamp: 1519211809934'
* param: message (string) - log message
*/
var info = function(header, message) {
    winston.log('info', header + " : " + message);
}

/*
* Log debug information
* param: header (string) - log header e.g. 'Debug Timestamp: 1519211809934'
* param: message (string) - log message
*/
var debug = function(header, message) {
    winston.log('debug', header + " : " + message);
}
